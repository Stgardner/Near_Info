 ...
 */
    ...
    pub fn info_hello(&mut self, name: String) -> String {
        ...
        format!("Hello {} this has been called {} times and the current block number is {} at {} and your current account balance is {}", name, self.val, block_height, block_timestamp, account_balance)
    }
